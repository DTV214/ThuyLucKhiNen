  ...
  return (
    <section className="relative isolate min-h-[650px] overflow-hidden bg-primary text-on-primary sm:min-h-[680px]">
      ...
      <div className="relative mx-auto flex min-h-[650px] max-w-7xl items-center px-gutter py-16 sm:min-h-[680px] sm:py-24">
        ...
        <div className="absolute bottom-8 right-gutter hidden items-center gap-3 rounded-xl bg-surface/95 px-4 py-3 text-on-surface shadow-xl backdrop-blur-md lg:flex"><Factory className="size-7 text-primary" /><span><strong className="block text-label-md">Giải pháp kỹ thuật công nghiệp</strong><small className="text-body-sm text-on-surface-variant">CTY ThanhDanh-VMC</small></span></div>
      </div>
